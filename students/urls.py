...
urlpatterns = [
    ...
    path('wil/learning/programme/registration/<int:pk>/registrations/logsheets/<int:block_pk>/<int:month_pk>/simulated',StudentLearningProgrammeRegistrationSimulatedWILLogsheetStaffList.as_view(),name='staff_simulated_wil_logsheets'),
    path('wil/learning/programme/registration/<int:pk>/registrations/logsheets/<int:block_pk>/<int:month_pk>/non-simulated',StudentLearningProgrammeRegistrationNonSimulatedWILLogsheetStaffList.as_view(),name='staff_non_simulated_wil_logsheets'),
