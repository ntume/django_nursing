...
@login_required()
def print_facility_list_excel(request,filterstr):

    '''
    Print facility booking List
    '''
    ...
    for booking in booking_list:
        ...
        row_tuple = (
            ...
            f"{ booking.role.role }",
            f"{ booking.facility_activity.facility.facility }",
            f"{ booking.facility_activity.activity.activity }",
            f"{ booking.booking_date }",
            f"{ booking.booking_time_start }",
            f"{ booking.booking_time_end }",
            f"{ booking.booking_description }",
            f"{ booking.status }",      
        )
